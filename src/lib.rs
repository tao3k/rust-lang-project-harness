...
pub use verification::{
    ...
    RustVerificationReportOptions, RustVerificationReportTemplate,
    RustVerificationReportTraceConfig, RustVerificationRequirement, RustVerificationResolutionNote,
    ...
    build_rust_verification_report_bundle_with_options, plan_rust_project_verification,
