...
pub use verification::{
    ...
    RustVerificationStabilityIndex, RustVerificationStabilityPicture,
    RustVerificationStabilityPictureConfig, RustVerificationStabilityPictureRecord,
    RustVerificationStabilityRecord, RustVerificationTask, RustVerificationTaskContract,
    RustVerificationTaskIndex, RustVerificationTaskKind, RustVerificationTaskRecord,
    RustVerificationTaskState, RustVerificationTraceMaxSeconds,
    ...
    build_rust_verification_stability_picture_from_index, build_rust_verification_task_index,
    check_rust_verification_report_manifest_schema, plan_rust_project_verification,
