...
/// Comparison applied to one Scenario-owned numeric metric.
#[derive(Clone, Copy, Debug, Deserialize, Eq, PartialEq)]
#[serde(rename_all = "lowercase")]
pub enum RustScenarioBenchmarkMetricKind {
    Stable,
    Exact,
    Maximum,
    Minimum,
...
/// One custom numeric metric generated by a Scenario implementation.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq)]
#[serde(deny_unknown_fields)]
pub struct RustScenarioBenchmarkMetric {
    pub unit: String,
    pub kind: RustScenarioBenchmarkMetricKind,
    #[serde(default)]
    pub target: Option<u64>,
    pub observed: u64,
}

/// Provenance and distribution emitted by the Scenario measurement runner.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq)]
#[serde(deny_unknown_fields)]
pub struct RustScenarioBenchmarkMeasurement {
    pub clock: String,
...
pub struct RustScenarioBenchmarkContract {
    ...
    /// Monotonic-clock sampling evidence for generated observations.
    #[serde(default)]
    pub measurement: Option<RustScenarioBenchmarkMeasurement>,
}
