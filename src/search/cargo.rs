...
pub(super) fn dependency_capability_guidance(
    ...
    Some(format!(
        "|dependency-topology dep={} usageLevel=local_usage topology=needs-index ownerUsage={} source=manifest,usage-index next=dependency-topology:{},crate-source:{},docs-use:{}",
        dependency,
